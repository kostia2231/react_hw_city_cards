...
import styles from "../citySelector/citySelector.module.css";
...
function CitySelector() {
  ...
  const [selectCity, setSelectCity] = useState(citiesData[0].name);
  const handleChange = (e) => {
    setSelectCity(e.target.value);
  };

  const currentCity = citiesData.find((city) => city.name === selectCity);
